              ...
              <textarea
                ...
                className={`w-full h-32 md:h-32 p-4 border-none rounded-2xl resize-none text-base touch-manipulation ${
                  entryExists 
                    ...
                    : 'bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-300 text-gray-700 placeholder-gray-400'
                }`}
            ...
            <div className="flex justify-between items-center">
              ...
              {currentStep < steps.length - 1 ? (
                <button
                  ...
                  className={`px-8 py-4 md:py-3 rounded-full font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 touch-manipulation min-h-[48px] ${
                    entryExists
                      ...
                      : 'bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 active:from-purple-700 active:to-pink-700 focus:ring-purple-500'
                  }`}
                ...
                <div className="flex flex-col items-end">
                  ...
                  {entryExists && (
                    <p className="text-sm text-gray-500 mt-2 text-right">
                      Please change the date above to create a new reflection
                    </p>
                  )}
                </div>
              )}
