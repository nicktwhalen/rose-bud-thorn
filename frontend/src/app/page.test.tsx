...
describe('Home Page', () => {
  ...
  it('submits form successfully', async () => {
    ...
    // Fill out all steps
    await user.type(
      screen.getByPlaceholderText('Share something that made you smile today...'),
      'Great weather'
    )
    await user.click(screen.getByText('Next'))
    
    await user.type(
      screen.getByPlaceholderText('It\'s okay to acknowledge the tough moments...'),
      'Long meeting'
    )
    await user.click(screen.getByText('Next'))
    
    await user.type(
      screen.getByPlaceholderText('What gives you hope for tomorrow?'),
      'Weekend plans'
    )
